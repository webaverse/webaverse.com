  ...
  })(
    {
        ...
        function (require, module, exports) {
          ...
          function i(r) {
            ...
            return (
              i === 2 &&
                ((n =
                  (t[r.charCodeAt(o)] << 2) | (t[r.charCodeAt(o + 1)] >> 4)),
                (f[A++] = 255 & n)),
              i === 1 &&
                ((n =
                  (t[r.charCodeAt(o)] << 10) |
        ...
        function (require, module, exports) {
          ;(exports.read = function (a, o, t, r, h) {
            ...
            (exports.write = function (a, o, t, r, h, M) {
              ...
              const i = (1 << e) - 1
              const N = i >> 1
              const n = h === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0
              let s = r ? 0 : M - 1
              const u = r ? 1 : -1
      ...
      S4UE: [
        function (require, module, exports) {
          ...
          function c(t, r) {
            if (
              (h(r), (t = u(t, r < 0 ? 0 : 0 | w(r))), !f.TYPED_ARRAY_SUPPORT)
            )
          ...
          function q(t, r, n, i, o) {
            return (
              o ||
                F(t, r, n, 8, 1.7976931348623157e308, -1.7976931348623157e308),
      ...
      lFsJ: [
        function (require, module, exports) {
          let e
          const t = typeof Reflect === 'object' ? Reflect : null
          const n =
          ...
          Object.defineProperty(o, 'defaultMaxListeners', {
            ...
            (o.prototype.emit = function (e) {
              ...
              if (typeof f === 'function') n(f, this, t)
              else {
                const v = f.length
                const l = p(f, v)
            ...
            (o.prototype.removeAllListeners = function (e) {
              ...
              if (arguments.length === 0) {
                ...
                for (r = 0; r < o.length; ++r)
                  (i = o[r]) !== 'removeListener' && this.removeAllListeners(i)
                return (
      ...
      Zx5D: [
        function (require, module, exports) {
          ...
          const r = require('buffer').Buffer
          function t(r) {
            return Array.isArray ? Array.isArray(r) : a(r) === '[object Array]'
          }
          function e(r) {
          ...
          function p(r) {
            return a(r) === '[object RegExp]'
          }
          function c(r) {
            return typeof r === 'object' && r !== null
          }
          function l(r) {
            return a(r) === '[object Date]'
          }
          function y(r) {
            return a(r) === '[object Error]' || r instanceof Error
          }
          function x(r) {
      ...
      prme: [function (require, module, exports) {}, {}],
      PVSS: [
        function (require, module, exports) {
          function t(t, n) {
            if (!(t instanceof n))
          ...
          const n = require('safe-buffer').Buffer
          ...
          ;(module.exports = (function () {
            ...
            e &&
              ...
              (module.exports.prototype[e.inspect.custom] = function () {
                const t = e.inspect({ length: this.length })
                return `${this.constructor.name} ${t}`
              })
        },
        { 'safe-buffer': 'Wugr', util: 'prme' },
      ],
      iXO9: [
        function (require, module, exports) {
          const t = require('process-nextick-args')
          function e(e, a) {
            const r = this
            const s = this._readableState && this._readableState.destroyed
            const d = this._writableState && this._writableState.destroyed
            return s || d
              ? (a
                  ? a(e)
                  : !e ||
      ...
      onTN: [
        function (require, module, exports) {
          ...
          const t = arguments[3]
          const n = require('process-nextick-args')
          function r(e, t, n) {
            ;(this.chunk = e),
              (this.encoding = t),
              (this.callback = n),
          ...
          const s = n.nextTick
          g.WritableState = y
          const f = Object.create(require('core-util-is'))
          f.inherits = require('inherits')
          const u = { deprecate: require('util-deprecate') }
          const a = require('./internal/streams/stream')
          const c = require('safe-buffer').Buffer
          const l = t.Uint8Array || function () {}
          function d(e) {
            return c.from(e)
          }
          function h(e) {
          ...
          let b
          const p = require('./internal/streams/destroy')
          function w() {}
          function y(e, t) {
            ...
            const s = e.writableHighWaterMark
          ...
          function _(e, t, n, r, i, o) {
            ...
            const f = t.objectMode ? 1 : r.length
            t.length += f
            const u = t.length < t.highWaterMark
            if ((u || (t.needDrain = !0), t.writing || t.corked)) {
              const a = t.lastBufferedRequest
          ...
          function T(e, t) {
            ...
            return (
              n &&
                (P(e, t),
                t.pendingcb === 0 && ((t.finished = !0), e.emit('finish'))),
              n
            )
          }
          function F(e, t, r) {
        ...
        },
        {
          ...
          inherits: 'Nucb',
          'util-deprecate': 'eu5b',
          './internal/streams/stream': 'D9LZ',
          'safe-buffer': 'Wugr',
          './internal/streams/destroy': 'iXO9',
          './_stream_duplex': 'UEw4',
          process: 'R3IB',
        },
      ],
      UEw4: [
        function (require, module, exports) {
          const e = require('process-nextick-args')
          const t =
            Object.keys ||
            function (e) {
              const t = []
          ...
          module.exports = l
          const r = Object.create(require('core-util-is'))
          r.inherits = require('inherits')
          const i = require('./_stream_readable')
          const a = require('./_stream_writable')
          r.inherits(l, i)
          for (let o = t(a.prototype), s = 0; s < o.length; s++) {
            const n = o[s]
        ...
        },
        {
          ...
          'core-util-is': 'Zx5D',
          inherits: 'Nucb',
          './_stream_readable': 'fWsz',
          './_stream_writable': 'onTN',
        },
      ],
      U7uF: [
        function (require, module, exports) {
          const t = require('safe-buffer').Buffer
          const e =
            t.isEncoding ||
            function (t) {
          ...
          function i(i) {
            const a = s(i)
            if (typeof a !== 'string' && (t.isEncoding === e || !e(i)))
          ...
          function u(t, e) {
            ...
            this.lastTotal = s
            const i = t.length - (s - this.lastNeed)
          ...
          function c(t, e) {
            if ((t.length - e) % 2 == 0) {
              const s = t.toString('utf16le', e)
              if (s) {
                const i = s.charCodeAt(s.length - 1)
                if (i >= 55296 && i <= 56319)
                  return (
                    (this.lastNeed = 2),
                    (this.lastTotal = 4),
          ...
          function f(t) {
            const e = t && t.length ? this.write(t) : ''
            if (this.lastNeed) {
              const s = this.lastTotal - this.lastNeed
              return e + this.lastChar.toString('utf16le', 0, s)
            }
            return e
          }
          function d(t, e) {
            const s = (t.length - e) % 3
            return s === 0
              ? t.toString('base64', e)
              : ((this.lastNeed = 3 - s),
                (this.lastTotal = 3),
      ...
      fWsz: [
        function (require, module, exports) {
          ...
          const process = require('process')
          const e = arguments[3]
          const t = require('process')
          const n = require('process-nextick-args')
          module.exports = _
          let r
          const i = require('isarray')
          _.ReadableState = w
          const a = require('events').EventEmitter
          const d = function (e, t) {
            return e.listeners(t).length
          }
          const o = require('./internal/streams/stream')
          const s = require('safe-buffer').Buffer
          const u = e.Uint8Array || function () {}
          function l(e) {
            return s.from(e)
          }
          function h(e) {
          ...
          const p = Object.create(require('core-util-is'))
          p.inherits = require('inherits')
          const f = require('util')
          let c = void 0
          c = f && f.debuglog ? f.debuglog('stream') : function () {}
          let g
          const b = require('./internal/streams/BufferList')
          const m = require('./internal/streams/destroy')
          p.inherits(_, o)
          const v = ['error', 'close', 'destroy', 'pause', 'resume']
          function y(e, t, n) {
          ...
          function w(e, t) {
            e = e || {}
            const n = t instanceof (r = r || require('./_stream_duplex'))
            ;(this.objectMode = !!e.objectMode),
              n && (this.objectMode = this.objectMode || !!e.readableObjectMode)
            const i = e.highWaterMark
            const a = e.readableHighWaterMark
            const d = this.objectMode ? 16 : 16384
            ;(this.highWaterMark =
              i || i === 0 ? i : n && (a || a === 0) ? a : d),
              (this.highWaterMark = Math.floor(this.highWaterMark)),
              (this.buffer = new b()),
          ...
          function O(e) {
            return function () {
              ...
              c('pipeOnDrain', t.awaitDrain),
                ...
                t.awaitDrain === 0 && d(e, 'data') && ((t.flowing = !0), B(e))
            }
          }
          function T(e) {
          ...
          function B(e) {
            const t = e._readableState
            for (c('flow', t.flowing); t.flowing && e.read() !== null; );
          }
          function H(e, t) {
            return t.length === 0
              ? null
          ...
          function A(e, t) {
            ...
            for (e -= i.length; (n = n.next); ) {
              const a = n.data
              const d = e > a.length ? a.length : e
              if (
                (d === a.length ? (i += a) : (i += a.slice(0, e)),
                (e -= d) === 0)
              ) {
                d === a.length
          ...
          function F(e, t) {
            ...
            for (r.data.copy(n), e -= r.data.length; (r = r.next); ) {
              const a = r.data
              const d = e > a.length ? a.length : e
              if ((a.copy(n, n.length - e, 0, d), (e -= d) === 0)) {
                d === a.length
          ...
          ;(_.prototype.read = function (e) {
            ...
            if (
              ...
              return (
                ...
                t.length === 0 && t.ended ? z(this) : q(this),
                null
              )
            if ((e = L(e, t)) === 0 && t.ended)
              return t.length === 0 && z(this), null
            let r
            ...
            (_.prototype.on = function (e, t) {
              const r = o.prototype.on.call(this, e, t)
              if (e === 'data')
        ...
        },
        {
          ...
          inherits: 'Nucb',
          util: 'prme',
          './internal/streams/BufferList': 'PVSS',
          './internal/streams/destroy': 'iXO9',
          './_stream_duplex': 'UEw4',
          'string_decoder/': 'U7uF',
          process: 'R3IB',
      ...
      CTnJ: [
        function (require, module, exports) {
          module.exports = n
          const t = require('./_stream_duplex')
          const r = Object.create(require('core-util-is'))
          function e(t, r) {
          ...
          function n(r) {
            ...
            t.call(this, r),
              ...
              r &&
                ...
                typeof r.flush === 'function' && (this._flush = r.flush)),
              this.on('prefinish', i)
          }
          function i() {
            const t = this
          ...
          function a(t, r, e) {
            ...
            if ((e != null && t.push(e), t._writableState.length))
          ...
          ;(r.inherits = require('inherits')),
            ...
            (n.prototype._read = function (t) {
              ...
              r.writechunk !== null && r.writecb && !r.transforming
                ? ((r.transforming = !0),
                  this._transform(
                    r.writechunk,
                    r.writeencoding,
            ...
            (n.prototype._destroy = function (r, e) {
              const n = this
              t.prototype._destroy.call(this, r, (t) => {
                e(t), n.emit('close')
              })
            })
        },
      ...
      HioB: [
        function (require, module, exports) {
          module.exports = t
          const r = require('./_stream_transform')
          const e = Object.create(require('core-util-is'))
          function t(e) {
      ...
      SG2O: [
        ...
        {
          './lib/_stream_readable.js': 'fWsz',
          './lib/_stream_writable.js': 'onTN',
          './lib/_stream_duplex.js': 'UEw4',
          './lib/_stream_transform.js': 'CTnJ',
          './lib/_stream_passthrough.js': 'HioB',
        },
      ],
      IOWG: [
        function (require, module, exports) {
      ...
      BCZI: [
        function (require, module, exports) {
          ...
          r(n, e),
            ...
            (n.prototype.pipe = function (r, n) {
              ...
              function u() {
                i || ((i = !0), typeof r.destroy === 'function' && r.destroy())
              }
              function d(r) {
                if ((l(), e.listenerCount(this, 'error') === 0)) throw r
              }
              function l() {
        ...
        },
        {
          events: 'lFsJ',
          inherits: 'Nucb',
          'readable-stream/readable.js': 'SG2O',
          'readable-stream/writable.js': 'IOWG',
          'readable-stream/duplex.js': 'jvh9',
          'readable-stream/transform.js': 'yFRU',
          'readable-stream/passthrough.js': 'kzPh',
        },
      ],
      UcQW: [
        function (require, module, exports) {
          const t = require('safe-buffer').Buffer
          const e = require('stream').Transform
          const i = require('inherits')
          function r(e, i) {
            if (!t.isBuffer(e) && typeof e !== 'string')
          ...
          i(o, e),
            ...
            (o.prototype.update = function (e, i) {
              ...
              for (
                ...
                for (let f = this._blockOffset; f < this._blockSize; )
                  o[f++] = e[s++]
                this._update(), (this._blockOffset = 0)
              }
              for (; s < e.length; ) o[this._blockOffset++] = e[s++]
              for (let n = 0, h = 8 * e.length; h > 0; ++n)
                (this._length[n] += h),
                  (h = (this._length[n] / 4294967296) | 0) > 0 &&
                    (this._length[n] -= 4294967296 * h)
              return this
            }),
        ...
        { 'safe-buffer': 'Wugr', stream: 'BCZI', inherits: 'Bm0n' },
      ],
      OP64: [
        function (require, module, exports) {
          const t = require('inherits')
          const i = require('hash-base')
          const s = require('safe-buffer').Buffer
          ...
          t(h, i),
            (h.prototype._update = function () {
              ...
              ;(s = _(s, h, r, o, t[0], 3614090360, 7)),
                ...
                (s = n(
                  s,
                  (h = _(h, r, o, s, t[15], 1236535329, 22)),
                  r,
                  o,
                  t[1],
                  4129170786,
                ...
                (s = c(
                  s,
                  (h = n(h, r, o, s, t[12], 2368359562, 20)),
                  r,
                  o,
                  t[5],
                  4294588738,
        ...
        { inherits: 'Bm0n', 'hash-base': 'UcQW', 'safe-buffer': 'Wugr' },
      ],
      quyi: [
        function (require, module, exports) {
          const t = require('buffer').Buffer
          const i = require('inherits')
          const s = require('hash-base')
          ...
          const c = [0, 1518500249, 1859775393, 2400959708, 2840853838]
          const o = [1352829926, 1548603684, 1836072691, 2053994217, 0]
          function f() {
            s.call(this, 64),
              (this._a = 1732584193),
              (this._b = 4023233417),
          ...
          i(f, s),
            ...
            (f.prototype._digest = function () {
              ;(this._block[this._blockOffset++] = 128),
                ...
                this._block.writeUInt32LE(this._length[1], 60),
                this._update()
              const i = t.alloc ? t.alloc(20) : new t(20)
              return (
        ...
        { buffer: 'S4UE', inherits: 'Bm0n', 'hash-base': 'UcQW' },
      ],
      VHby: [
        function (require, module, exports) {
          const t = require('safe-buffer').Buffer
          ...
          ;(i.prototype.update = function (i, e) {
            typeof i === 'string' && ((e = e || 'utf8'), (i = t.from(i, e)))
            for (
              var s = this._block,
                o = this._blockSize,
                l = i.length,
            ...
            (i.prototype.digest = function (t) {
              const i = this._len % this._blockSize
              ;(this._block[i] = 128),
              ...
              if (e <= 4294967295)
                ...
                const s = (4294967295 & e) >>> 0
                const o = (e - s) / 4294967296
      ...
      j9dE: [
        function (require, module, exports) {
          const t = require('inherits')
          const i = require('./hash')
          const r = require('safe-buffer').Buffer
          const s = [1518500249, 1859775393, -1894007588, -899497514]
          ...
          t(e, i),
            ...
            (e.prototype._update = function (t) {
              ...
              for (let c = 0; c < 80; ++c) {
                const d = ~~(c / 20)
                const p = (n(r) + a(d, h, e, o) + u + i[c] + s[d]) | 0
        ...
        { inherits: 'Bm0n', './hash': 'VHby', 'safe-buffer': 'Wugr' },
      ],
      oPH4: [
        function (require, module, exports) {
          const t = require('inherits')
          ...
          t(h, i),
            ...
            (h.prototype._update = function (t) {
              ...
              for (let d = 0; d < 80; ++d) {
                const p = ~~(d / 20)
                const w = (_(r) + o(p, e, h, a) + f + i[d] + s[p]) | 0
      ...
      IUSb: [
        function (require, module, exports) {
          const t = require('inherits')
          const i = require('./hash')
          const h = require('safe-buffer').Buffer
          const s = [
          ...
          t(_, i),
            ...
            (_.prototype._update = function (t) {
              ...
              for (let p = 0; p < 64; ++p) {
                const b = (I + f(w) + n(w, B, E) + s[p] + i[p]) | 0
                const g = (u(h) + e(h, r, _)) | 0
                ;(I = E),
                  (E = B),
                  (B = w),
                  (w = (c + b) | 0),
      ...
      MeLE: [
        function (require, module, exports) {
          const t = require('inherits')
          const i = require('./sha256')
          const e = require('./hash')
          const r = require('safe-buffer').Buffer
      ...
      sILY: [
        function (require, module, exports) {
          const h = require('inherits')
          const t = require('./hash')
          const i = require('safe-buffer').Buffer
          const s = [
      ...
      bjfr: [
        function (require, module, exports) {
          const t = require('safe-buffer').Buffer
          const i = require('stream').Transform
          const r = require('string_decoder').StringDecoder
          ...
          e(n, i),
            (n.prototype.update = function (i, r, e) {
              typeof i === 'string' && (i = t.from(i, r))
              let n = this._update(i)
      ...
      LF8r: [
        function (require, module, exports) {
          const e = require('inherits')
          const r = require('md5.js')
          const t = require('ripemd160')
          const i = require('sha.js')
          const s = require('cipher-base')
          function n(e) {
      ...
      Zu0X: [
        function (require, module, exports) {
          const { Buffer } = require('buffer')
          const r = require('buffer').Buffer
          const e = Math.pow(2, 30) - 1
          function o(e, o) {
            if (typeof e !== 'string' && !r.isBuffer(e))
              throw new TypeError(`${o} must be a buffer or string`)
          }
          module.exports = function (r, t, n, f) {
            if ((o(r, 'Password'), o(t, 'Salt'), typeof n !== 'number'))
      ...
      ATA7: [
        function (require, module, exports) {
          ...
          ;(e = 'utf-8'), (module.exports = e)
        },
        { process: 'R3IB' },
      ],
      Mobq: [
        function (require, module, exports) {
          const e = require('md5.js')
      ...
      yOuH: [
        function (require, module, exports) {
          const e = require('create-hash/md5')
          const r = require('ripemd160')
          const a = require('sha.js')
          const i = require('./precondition')
          const t = require('./default-encoding')
          const s = require('safe-buffer').Buffer
          const n = s.alloc(128)
          const h = {
            md5: 16,
          ...
          function o(e, r, a) {
            const i = u(e)
            const t = e === 'sha512' || e === 'sha384' ? 128 : 64
            r.length > t
              ? (r = i(r))
              : r.length < t && (r = s.concat([r, n], t))
            for (
              var o = s.allocUnsafe(t + h[e]),
                f = s.allocUnsafe(t + h[e]),
                c = 0;
              c < t;
              c++
            )
              (o[c] = 54 ^ r[c]), (f[c] = 92 ^ r[c])
            const l = s.allocUnsafe(t + a + 4)
            o.copy(l, 0, 0, t),
              (this.ipad1 = l),
              (this.ipad2 = o),
              (this.opad = f),
          ...
          function f(e, r, a, n, u) {
            ...
            const f = new o((u = u || 'sha1'), e, r.length)
            const c = s.allocUnsafe(n)
            const l = s.allocUnsafe(r.length + 4)
            r.copy(l, 0, 0, r.length)
            for (
              let d = 0, p = h[u], m = Math.ceil(n / p), g = 1;
              g <= m;
              g++
            ) {
      ...
      Q3c6: [
        function (require, module, exports) {
          ...
          const e = arguments[3]
          const n = require('process')
          const t = require('./precondition')
          const o = require('./default-encoding')
          const i = require('./sync')
          const u = require('safe-buffer').Buffer
          const f = e.crypto && e.crypto.subtle
          const s = {
            sha: 'SHA-1',
            'sha-1': 'SHA-1',
            sha1: 'SHA-1',
          ...
          function a(n) {
            ...
            const t = h((r = r || u.alloc(8)), r, 10, 128, n)
              .then(() => !0)
              .catch(() => !1)
            return (c[n] = t), t
          }
          function h(r, e, n, t, o) {
            return f
              .importKey('raw', r, { name: 'PBKDF2' }, !1, ['deriveBits'])
              .then((r) =>
                f.deriveBits(
                  {
                    name: 'PBKDF2',
          ...
          module.exports = function (r, f, c, p, m, d) {
            typeof m === 'function' && ((d = m), (m = void 0))
            const v = s[(m = m || 'sha1').toLowerCase()]
            if (!v || typeof e.Promise !== 'function')
              return n.nextTick(() => {
                let e
                try {
                  e = i(r, f, c, p, m)
            ...
            if ((t(r, f, c, p), typeof d !== 'function'))
              throw new Error('No callback provided to pbkdf2')
            u.isBuffer(r) || (r = u.from(r, o)),
              u.isBuffer(f) || (f = u.from(f, o)),
              l(
                a(v).then((e) => (e ? h(r, f, c, p, v) : i(r, f, c, p, m))),
                d,
              )
          }
        },
      ...
      XJNj: [
        function (require, module, exports) {
          ...
          const s = require('safe-buffer').Buffer
          const u = e.crypto || e.msCrypto
          function a(e, t) {
            if (e > n) throw new RangeError('requested too many random bytes')
            const a = s.allocUnsafe(e)
            if (e > 0)
              if (e > o)
                for (let f = 0; f < e; f += o)
                  u.getRandomValues(a.slice(f, f + o))
      ...
      ihmB: [
        function (require, module, exports) {
          ...
          let e
          const t = {}
          ;(exports.wordlists = t), (exports._default = e)
          try {
            ;(exports._default = e =
              require('./wordlists/chinese_simplified.json')),
              (t.chinese_simplified = e)
          } catch (r) {}
          try {
            ;(exports._default = e =
              require('./wordlists/chinese_traditional.json')),
              (t.chinese_traditional = e)
          } catch (r) {}
          try {
            ;(exports._default = e = require('./wordlists/korean.json')),
              (t.korean = e)
          } catch (r) {}
          try {
            ;(exports._default = e = require('./wordlists/french.json')),
              (t.french = e)
          } catch (r) {}
          try {
            ;(exports._default = e = require('./wordlists/italian.json')),
              (t.italian = e)
          } catch (r) {}
          try {
            ;(exports._default = e = require('./wordlists/spanish.json')),
              (t.spanish = e)
          } catch (r) {}
          try {
            ;(exports._default = e = require('./wordlists/japanese.json')),
              (t.japanese = e),
              (t.JA = e)
          } catch (r) {}
          try {
            ;(exports._default = e = require('./wordlists/english.json')),
              (t.english = e),
              (t.EN = e)
          } catch (r) {}
        },
        {
          './wordlists/chinese_simplified.json': 'oJHw',
          './wordlists/chinese_traditional.json': 'ghXs',
          './wordlists/korean.json': 'puGr',
          './wordlists/french.json': 'lJit',
          './wordlists/italian.json': 'hW5Q',
          './wordlists/spanish.json': 'KDer',
          './wordlists/japanese.json': 'MaGn',
          './wordlists/english.json': 'MNjf',
        },
      ],
      Focm: [
        function (require, module, exports) {
          ...
          const r = require('buffer').Buffer
          Object.defineProperty(exports, '__esModule', { value: !0 })
          const e = require('create-hash')
          const n = require('pbkdf2')
          const t = require('randombytes')
          const o = require('./_wordlists')
          let i = o._default
          const u = 'Invalid mnemonic'
          const f = 'Invalid entropy'
          const s = 'Invalid mnemonic checksum'
          const a =
            'A wordlist is required but a default could not be found.\nPlease explicitly pass a 2048 word array explicitly.'
          function c(r, e, t, o, i) {
            return Promise.resolve().then(
              () =>
                new Promise((u, f) => {
                  n.pbkdf2(r, e, t, o, i, (r, e) => (r ? f(r) : u(e)))
                }),
            )
          }
          function l(r) {
          ...
          function d(r) {
            return r.map((r) => w(r.toString(2), '0', 8)).join('')
          }
          function m(r) {
            const n = (8 * r.length) / 32
            const t = e('sha256').update(r).digest()
            return d(Array.from(t)).slice(0, n)
          }
          function p(r) {
            return `mnemonic${r || ''}`
          }
          function g(e, t) {
            const o = r.from(l(e), 'utf8')
            const i = r.from(p(l(t)), 'utf8')
            return n.pbkdf2Sync(o, i, 2048, 64, 'sha512')
          }
          function v(e, n) {
            return Promise.resolve().then(() =>
              c(
          ...
          function y(e, n) {
            if (!(n = n || i)) throw new Error(a)
            const t = l(e).split(' ')
            if (t.length % 3 != 0) throw new Error(u)
            const o = t
              .map((r) => {
                const e = n.indexOf(r)
                if (e === -1) throw new Error(u)
                return w(e.toString(2), '0', 11)
              })
              .join('')
            const c = 32 * Math.floor(o.length / 33)
            const d = o.slice(0, c)
            const p = o.slice(c)
            const g = d.match(/(.{1,8})/g).map(h)
            if (g.length < 16) throw new Error(f)
            if (g.length > 32) throw new Error(f)
            if (g.length % 4 != 0) throw new Error(f)
            const v = r.from(g)
            if (m(v) !== p) throw new Error(s)
            return v.toString('hex')
          }
          function E(e, n) {
            if ((r.isBuffer(e) || (e = r.from(e, 'hex')), !(n = n || i)))
              throw new Error(a)
            if (e.length < 16) throw new TypeError(f)
            if (e.length > 32) throw new TypeError(f)
            if (e.length % 4 != 0) throw new TypeError(f)
            const t = (d(Array.from(e)) + m(e)).match(/(.{1,11})/g).map((r) => {
              const e = h(r)
              return n[e]
            })
            return n[0] === 'あいこくしん' ? t.join('　') : t.join(' ')
          }
          function x(r, e, n) {
            if ((r = r || 128) % 32 != 0) throw new TypeError(f)
            return E((e = e || t)(r / 8), n)
          }
          function b(r, e) {
            try {
              y(r, e)
          ...
          function T(r) {
            const e = o.wordlists[r]
            if (!e)
              throw new Error(`Could not find wordlist for language "${r}"`)
            i = e
          }
          function q() {
            if (!i) throw new Error('No Default Wordlist set')
            return Object.keys(o.wordlists).filter(
              (r) =>
                r !== 'JA' &&
                r !== 'EN' &&
                o.wordlists[r].every((r, e) => r === i[e]),
            )[0]
          }
          ;(exports.mnemonicToSeedSync = g),
            (exports.mnemonicToSeed = v),
            (exports.mnemonicToEntropy = y),
            (exports.entropyToMnemonic = E),
            (exports.generateMnemonic = x),
            (exports.validateMnemonic = b),
            (exports.setDefaultWordlist = T),
            (exports.getDefaultWordlist = q)
          const S = require('./_wordlists')
          exports.wordlists = S.wordlists
        },
        {
          'create-hash': 'LF8r',
          pbkdf2: 'BKdu',
