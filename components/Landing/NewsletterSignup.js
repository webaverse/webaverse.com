const NewsletterSignup = ({ title, description, cta }) => (
    <div className="">
        <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:py-16 lg:px-8">
            <div className="py-10 px-6 bg-indigo-700 rounded-3xl sm:py-16 sm:px-12 lg:p-20 lg:flex lg:items-center">
                ...
                <div className="mt-12 sm:w-full sm:max-w-md lg:mt-0 lg:ml-8 lg:flex-1">
                    <form className="sm:flex" method="post" target="_blank" action="https://webaverse.us7.list-manage.com/subscribe/post?u=2ede3716258e23a8f1ed28d76&id=29ede072f5" noValidate id="mc-embedded-subscribe-form">
